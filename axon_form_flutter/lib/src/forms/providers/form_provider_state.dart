...
class FormProviderState extends ChangeNotifier {
  ...
  bool get isLastPage =>
      formGraph != null && currentPage == formGraph!.layout.pages.length - 1;
  ...
  Future<bool> advanceOrSubmit({
    void Function(Map<String, dynamic>)? onSubmitted,
  }) async {
