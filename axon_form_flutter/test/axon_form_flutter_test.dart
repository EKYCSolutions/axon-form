...
void main() {
  final AxonFormFlutterPlatform initialPlatform = AxonFormFlutterPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    AxonFormFlutter axonFormFlutterPlugin = AxonFormFlutter();
    MockAxonFormFlutterPlatform fakePlatform = MockAxonFormFlutterPlatform();
    AxonFormFlutterPlatform.instance = fakePlatform;

    expect(await axonFormFlutterPlugin.getPlatformVersion(), '42');
  });
}
