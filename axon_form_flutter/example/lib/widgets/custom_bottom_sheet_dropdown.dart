...
//   LocationOption(this.title, this.subtitle);
// }
...
//   @override
//   State<CustomBottomSheetDropdown> createState() => _CustomBottomSheetDropdownState();
// }
...
//     LocationOption("ស្ទឹងត្រង់", "OTHER"),
//     LocationOption("ភូមិ ៧ 10", "PHUM"),
//     LocationOption("ភូមិ 19", "PHUM 11"),
//     LocationOption("ភូមិ 19", "PHUM"),
//     LocationOption("ភូមិ 13 13", "PHUM 12"),
//     LocationOption("ភូមិ ១ត", "PHUM 13"),
//   ];
...
//                       itemBuilder: (context, index) {
//                         final item = options[index];
//                         final bool isSelected = selectedLocation?.title == item.title;
...
//                           ),
//                           onTap: () {
//                             setState(() => selectedLocation = item);
//                             Navigator.pop(context);
//                           },
//                         );
//                       },
...
//             ),
//             child: Text(selectedLocation?.title ?? "ជ្រើសរើសភូមិ (Select Village)"),
//           ),
//         ),
//       ),
//     );
